...
<br><br><br>
<a href="${pageContext.request.contextPath}/probono/activistUpdateReq?activistId=${requestScope.activist.id}">수정하기</a>

<a href="${pageContext.request.contextPath}/probono/activistDelete?activistId=${requestScope.activist.id}">탈퇴하기</a>
